			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-4">
							<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Tìm kiếm theo tên ...">
							 </div>
							<div class="col-xs-8">
									...
									<div class="pull-right tableTools-container">
										<div class="dt-buttons btn-overlap btn-group">
											<a flag="info"
												...
												data-toggle="tooltip" title="Thêm bàn"
												href='<c:url value="/admin/table/edit"/>'> <span>
													<i class="fa fa-plus-circle bigger-110 purple"></i>
											</span>
											</a>
											<button id="btnDelete" type="button"
												class="dt-button buttons-html5 btn btn-white btn-primary btn-bold"
												data-toggle="tooltip" title="Xóa bàn"
										...
										<tbody id = "myTable">
											<c:forEach var="item" items="${tables}">
												<tr>
													...
													<td><c:url var="editTable" value="/admin/table/edit">
															<c:param name="id" value="${item.id}" />
														</c:url> <a class="btn btn-sm btn-primary btn-edit"
														data-toggle="tooltip" title="Cập nhật bàn"
														href='${editTable}'> <i class="fa fa-pencil-square-o"
