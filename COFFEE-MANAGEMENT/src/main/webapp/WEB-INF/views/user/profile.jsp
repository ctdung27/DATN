                ...
                <div class="col-xs-12">
                    ...
                    <form:form id="formEdit" commandName="model">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" id="password" name="password" placeholder="Nếu muốn thay đổi mật khẩu, thì nhập mật khẩu mới, không thay đồi thì để trống"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
    ...
    function updateUser(data) {
        $.ajax({
            ...
            success: function(res) {
                window.location.href = "<c:url value='/admin/user/profile?id="+res.id+"&message=update_success'/>";
            },
            error: function(res) {
                window.location.href = "<c:url value='/admin/user/profile?id="+res.id+"&message=error_system'/>";
            }
        });
    }
</script>
