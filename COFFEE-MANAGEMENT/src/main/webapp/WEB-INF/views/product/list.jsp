                                    ...
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
                                               data-toggle="tooltip" title="Thêm sản phẩm" href='<c:url value="/admin/product/edit"/>'>
                                                    <span>
                                        ...
                                        <tbody>
                                            <c:forEach var="item" items="${products}">
                                                <tr>
                                                    ...
                                                    <td>${item.price}</td>
                                                    <td>
                                                        <c:url var="editProduct" value="/admin/product/edit">
                                                            <c:param name="id" value="${item.id}"/>
                                                        </c:url>
                                                        <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                           title="Cập nhật sản phẩm" href='${editProduct}'><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
