...
<c:url var="formUrl" value="/api/productcategory"/>
<html>
<head>
							...
							<div class="panel-body">
								...
								<div class="panel-footer">
									...
									<c:if test="${not empty model.id}">
										<input type="button"
											class="btn btn-success btn-bold" value="Cập nhật"
											id="btnAddOrUpdateProductCategory" />
										<a href="/admin/productcategory/list" class="btn  btn-warning btn-bold">Trở
											về</a>
									</c:if>
									<c:if test="${empty model.id}">
										<input type="button"
											class="btn btn-success btn-bold" value="Thêm mới"
											id="btnAddOrUpdateProductCategory" />
										<a href="/admin/productcategory/list" class="btn  btn-warning btn-bold">Trở
											về</a>
									</c:if>
