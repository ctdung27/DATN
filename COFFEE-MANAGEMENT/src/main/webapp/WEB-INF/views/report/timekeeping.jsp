...
<body class="no-skin">
									...
									<div class="widget-main no-padding">
										<div id="external-events">
											...
											<label> <input type="checkbox"
												class="ace ace-checkbox" id="drop-remove" checked /> <span
	...
	<script type="text/javascript">
		...
		<script src="/template/admin/assets/js/moment.min.js"></script>
		<script src="/template/admin/assets/js/fullcalendar.min.js"></script>
		<script src="/template/admin/assets/js/bootbox.js"></script>
